namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrYachtAvgTickPriceMethodsWrapper

	/// <exclude/>
	public class UsrYachtAvgTickPriceMethodsWrapper : ProcessModel
	{

		public UsrYachtAvgTickPriceMethodsWrapper(Process process)
			: base(process) {
		...
		private bool ScriptTask1Execute(ProcessExecutingContext context) {
			...
			var passengerCountColumn = esq.AddColumn("UsrPassengerCount");  // SELECT UsrPassengerCount as UsrPassengerCount, UsrPrice as UsrPrice FROM UsrYacht WHERE ...
